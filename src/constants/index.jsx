export const features = [
    {
      ...
      caption: "Seamless Vansales Execution",
      title: "Work smarter",
      text: "Enable sales teams to manage orders, invoice, and deliver efficiently, directly from the field ",
      button: {
    ...
    },
    {
      ...
      title: "Very Simple",
      text: "Track inventory levels across all locations to prevent stockouts and optimize reordering.",
      button: {
  ...
  export const details = [
    {
      ...
      title: "Compliant Field Invoicing",
    },
  ...
  export const faq = [
    {
      id: "0",
      question: "How easy is it to setup Aximos?",
      answer:
        "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
    },
    {
      id: "1",
      question: "Can I integrate Aximos with other platforms?",
      answer:
        "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
    },
    {
  ...
  export const plans = [
    {
      ...
      caption: "Best for small enterprises",
      features: [
        "Stock Management",
        "Vansales",
        "Proof of Delivery",
